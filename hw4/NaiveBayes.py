...
class NaiveBayes:
    ...
    def classify(self, words):
        ...
        if self.naiveBayesBool:
            for word in words:
                # test for pos
                posword_log = math.log(self.poswords[word] + 18)
                POS += posword_log
                POS -= math.log(pos_count + 18*len(self.vtotal))
            ...
            for word in words:
                # test for pos
                posword_log = math.log(self.poswords[word] + 20)
                POS += posword_log
                POS -= math.log(pos_count + 20*len(self.vtotal))
            ...
            for word in words:
                # test for pos
                posword_log = math.log(self.poswords[word] + 1)
                POS += posword_log
                POS -= math.log(pos_count + len(self.vtotal))
